...
class TestUser(unittest.TestCase):
    ...
    def test_schedule(self):
        """test that the schedule method returns the expected values"""
        u = {"first_name": "Kimmie", "activity": "Trumpet",
             "email": "kk@mm.com", "password": "kkmm"}
        user = User(**u)
        user.save()
        ss = user.schedule()
        self.assertEqual(ss, [])
        ...
        #self.assertEqual(s[0], log.lesson_time)
        #self.assertEqual(s[1], student.first_name)
        #self.assertEqual(s[2], student.id)
